        ...
        fetch(`/usr/chat/getMessages/${room.id}/?fromId=\${ChatMessages__lastId}`)
            ...
            .then(responseData => {
                ...
                if ( messages.length > 0 ) {
                    ChatMessages__loadMore = messages[messages.length - 1].id;
                }

                // messages__loadMore(); // 즉시 실행
                setTimeout(ChatMessages__loadMore, 3000); // ChatMessages__loadMore(); 를 3초마다 1번씩 요청
            });
    }
</script>
